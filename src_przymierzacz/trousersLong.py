...
from Bender import *
class trousersLong(FunkcjePomocnicze,FunkcjeNogawkowoRekawowe):
	...
	def __init__(self,body_object, cloath_url):
		...
		print "PRAWA NOGA "
		kluczeR = ['loin#R','leg#R#outside','leg#R#inside','ankle#R#inside','ankle#R#outside','knee#R#inside','knee#R#outside']
